...
@Testcontainers
@ContextConfiguration(initializers = se.nackademin.java20.lab1.Lab1ApplicationTests.Lab1ApplicationTestsContextInitializer.class)
...
class Lab1ApplicationTests {
    ...
    void shouldOpenAccountWhenRiskAssessmentPasses() throws Exception {
        wireMockServer.stubFor(get(urlEqualTo("/risk/dan"))
